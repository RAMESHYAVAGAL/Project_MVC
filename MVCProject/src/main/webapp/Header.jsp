...
<html>
    ...
    <body style="margin: 0;">
        <ul>
            ...
            <li style="float:left"><img style="width:35px; height:35px; padding-top:5px"src="https://media.istockphoto.com/id/1125279178/vector/mail-line-icon.jpg?s=612x612&w=0&k=20&c=NASq4hMg0b6UP9V0ru4kxL2-J114O3TaakI467Pzjzw=" ></li>
        </ul>
    </body>
</html>
